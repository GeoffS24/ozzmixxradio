      ...
      <div className="flex container mx-auto w-full flex-col items-start gap-12 lg:gap-20">
        <div className="flex max-w-[560px] flex-col items-start gap-8 lg:gap-8 w-full">
          ...
          <div className="flex items-start gap-4">
            <Link href={heroData.primaryButton.link || "#listen"}>
              <Button variant="secondary" size="md">
                {heroData.primaryButton.text}
              </Button>
            </Link>
            <Link href={heroData.secondaryButton.link || "#join"}>
              <Button
                variant="ghost"
                size="md"
                className="border border-white/20 text-white hover:bg-white/10 hover:border-primary"
              >
