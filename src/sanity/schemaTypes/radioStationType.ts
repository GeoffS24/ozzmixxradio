    ...
    defineField({
      ...
      fields: [
        defineField({
          ...
          type: 'url',
          description: 'Primary radio stream URL (supports MP3, AAC, and HLS)',
          initialValue: 'https://stream.ozzmixxradio.com/hls/ozzmixxradio/live.m3u8',
        }),
        defineField({
          name: 'statusApiUrl',
          ...
          initialValue: 'https://stream.ozzmixxradio.com/api/nowplaying',
        }),
        defineField({
        ...
        defineField({
          name: 'showListenerCount',
          title: 'Show Listener Count',
          type: 'boolean',
          description: 'Whether to display the current listener count on the radio player',
          initialValue: true,
        }),
      ],
    }),
